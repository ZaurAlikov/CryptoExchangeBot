...
public interface TradeOperation {
    ...
    String getQtyForBuy(String pair, BigDecimal amt, PairTriangle triangle, TradeType tradeType);

    String getQtyForSell(String pair, BigDecimal amt, PairTriangle triangle, TradeType tradeType);
